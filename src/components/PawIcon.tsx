...
interface PawIconProps {
  fillRatio?: number // 1: full, 0.5: half, 0: empty
}

const PawIcon: React.FC<PawIconProps> = ({fillRatio = 1}) => {
  // === 여기에 로그가 있는지 확인 ===
  // console.log(`[PawIcon] --- START --- Received fillRatio: ${fillRatio}`)
  // =================================
  return (
    <svg
      viewBox="-5.86 -5.86 60.56 60.56"
      width="24"
      height="24"
      ...
      <path
        d="M39.041,36.843c2.054,3.234,3.022,4.951,3.022,6.742c0,3.537-2.627,5.252-6.166,5.252 
          -1.56,0-2.567-0.002-5.112-1.326c0,0-1.649-1.509-5.508-1.354c-3.895-0.154-5.545,1.373-5.545,1.373 
      ...
      {/* 채워진 영역 (fillRatio에 따라 clip) */}
      {fillRatio > 0 && (
        <clipPath id="clip">
          <rect x="-5.86" y="-5.86" width={`${60.56 * fillRatio}`} height="60.56" />
        </clipPath>
      )}
      {fillRatio > 0 && (
        <path
