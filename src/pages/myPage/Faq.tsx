                  ...
                  <div className="accordion-item">
                    ...
                    <div
                      ...
                      <div className="accordion-body">
                        <p>
                          1. 메인 페이지에서 원하시는 서비스(펫호텔, 애견미용, 훈련 등)를
                          선택합니다.
                          <br />
                          2. 원하시는 날짜와 시간을 선택합니다.
                          <br />
                          3. 반려동물의 정보(나이, 품종, 특이사항 등)를 상세히 입력합니다.
                          <br />
                          4. 결제를 진행합니다.
                        </p>
                        <p>
                          예약이 완료되면 문자메시지와 이메일로 예약 확인 메시지가
                          발송되며, 서비스 제공자가 24시간 이내에 예약을 확정해 드립니다.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div
                      ...
                      <div className="accordion-body">
                        ...
                        <p>
                          ...
                          <br />
                          - 천재지변으로 인한 취소: 100% 환불
                          <br />- 서비스 제공자의 사유로 인한 취소: 100% 환불 및 추가 보상
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="row d-flex">
                    <div className="col-lg-6 col-12">
                      ...
                      <div className="single-info">
                          <h3>고객센터 안내</h3>
                          <p>
                            서비스 이용에 궁금하신 점이 있으시다면 언제든 문의해 주세요.
                            친절하고 상세한 답변으로 도와드리겠습니다.
                          </p>
                        </div>
                        <div className="single-info">
                          <h3>운영시간</h3>
                        ...
                        <div className="single-info">
                          ...
                          <ul>
                            ...
                            <li>펫케어타워 8층</li>
                            <li>
                              <a href="support@unknownpaw.com">support@unknownpaw.com</a>
                            </li>
                            <li>
                              <a href="tel:1234-5678">1234-5678</a>
                            </li>
                            <li>긴급상황 핫라인: 1234-5678</li>
                          </ul>
                        </div>
                    ...
                    <div className="col-lg-6 col-12">
                      ...
                      <div className="single-info">
                          <h3>문의하기</h3>
                          <p>
                            서비스 이용 중 불편사항이나 문의사항이 있으시다면 아래 양식을
                            작성해 주세요.
                          </p>
                        </div>
